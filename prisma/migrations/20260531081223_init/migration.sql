-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('OWNER', 'EDITOR', 'REVIEWER', 'WRITER');

-- CreateEnum
CREATE TYPE "public"."ProjectStatus" AS ENUM ('ACTIVE', 'PAUSED', 'COMPLETED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "public"."ContentType" AS ENUM ('BLOG', 'EMAIL', 'SOCIAL_POST', 'LANDING_PAGE', 'AD_COPY');

-- CreateEnum
CREATE TYPE "public"."ContentStatus" AS ENUM ('DRAFT', 'GENERATING', 'REVIEWING', 'APPROVED', 'PUBLISHED');

-- CreateEnum
CREATE TYPE "public"."TaskType" AS ENUM ('RESEARCH', 'OUTLINE', 'WRITE_DRAFT', 'REVIEW', 'SEO_OPTIMIZE', 'PUBLISH');

-- CreateEnum
CREATE TYPE "public"."TaskStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED', 'FAILED');
...
-- AddForeignKey
ALTER TABLE "public"."Content" ADD CONSTRAINT "Content_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "public"."Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Task" ADD CONSTRAINT "Task_contentId_fkey" FOREIGN KEY ("contentId") REFERENCES "public"."Content"("id") ON DELETE SET NULL ON UPDATE CASCADE;
